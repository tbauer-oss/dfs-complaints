...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (isExpectedAnchorsMissingError(err)) {
      console.error('[regulatory/apply] EXPECTED_ANCHORS_MISSING', {
      ...
      return bad(
        res,
        'EXPECTED_ANCHORS_MISSING: EUR-Lex page structure changed. No DB writes were applied; retry once anchors are available.',
        500,
