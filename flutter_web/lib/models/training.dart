...
class TrainingNeed {
  ...
  factory TrainingNeed.fromJson(Map<String, dynamic> json) {
    return TrainingNeed(
      ...
      recurrenceIntervalMonths: (json['recurrenceIntervalMonths'] ?? 0) is num
          ? (json['recurrenceIntervalMonths'] as num).toInt()
          : int.tryParse((json['recurrenceIntervalMonths'] ?? '').toString()),
      ...
      lastGeneratedAt: (json['lastGeneratedAt'] ?? 0) is num
          ? (json['lastGeneratedAt'] as num).toInt()
          : int.tryParse((json['lastGeneratedAt'] ?? '').toString()),
      parentRecurringId:
