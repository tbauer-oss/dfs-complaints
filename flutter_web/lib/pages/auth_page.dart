...
class AuthPage extends StatefulWidget {
  final ApiClient api; final VoidCallback onLoggedIn;
        ...
        ElevatedButton(
          onPressed: _busy ? null : () async {
            ...
            if (isLogin){
              ...
              if (ok) widget.onLoggedIn(); else setState(()=>_err=t.login_failed);
            } else {
              if (!_privacy) { setState(()=>_busy=false); setState(()=>_err=t.privacy_required); return; }
