...
class _ComplaintFormPageState extends State<ComplaintFormPage> {
  ...
  Future<void> pickFiles(AppLocalizations t) async {
    ...
    String _guessMime(String name) {
      ...
      switch (ext) { case 'jpg': case 'jpeg': return 'image/jpeg';
        case 'png': return 'image/png'; case 'gif': return 'image/gif';
        case 'webp': return 'image/webp'; default: return 'application/octet-stream'; }
    }
          ...
          child: Column(
            ...
            children: [
              DropdownButtonFormField(
                ...
                onChanged: (v) => setState(() { segment = v as String; _dirty = true; }),
              ...
              if (isDentist) ...[
                ...
                DropdownButtonFormField(
                  ...
                  onChanged: (v) => setState(() { applied = v as String; _dirty = true; }),
                ...
                DropdownButtonFormField(
                  value: injury,
                  items: [DropdownMenuItem(value: optYes, child: Text(optYes)), DropdownMenuItem(value: optNo, child: Text(optNo))],
                  onChanged: (v) => setState(() { injury = v as String; _dirty = true; }),
              ...
              DropdownButtonFormField(
                ...
                onChanged: (v) => setState(() { returned = v as String; _dirty = true; }),
              ...
              DropdownButtonFormField(
                ...
                onChanged: (v) => setState(() { handling = v as String; _dirty = true; }),
