    ...
    return Padding(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Text(
              '${t.gsprColumnNumber} ${entry.requirement.ref}',
            ...
            if (entry.requirement.isAssessable &&
                (entry.requirement.contextText ?? '').trim().isNotEmpty)
              Container(
                margin: const EdgeInsets.only(bottom: 12),
                decoration: BoxDecoration(
                          ...
                          children: [
                            Expanded(
                              child: TextField(
                                ...
                                onChanged: (value) => _updateEvidence(
                                  index,
                                  evidence.copyWith(docId: value),
                                ),
                              ),
                            ),
                            const SizedBox(width: 12),
                            Expanded(
                              child: TextField(
                                ...
                                onChanged: (value) => _updateEvidence(
                                  index,
                                  evidence.copyWith(revision: value),
                                ),
                              ),
                            ),
                          ],
