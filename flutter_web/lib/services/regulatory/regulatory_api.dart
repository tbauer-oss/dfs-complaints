...
class RegulatoryApi {
  ...
  Future<Map<String, dynamic>> apply(String slug, String syncToken, String expectedLabel) =>
      client.regulatoryApply(slug, syncToken: syncToken, expectedVersionLabel: expectedLabel);
